...
def classify(frame, face_detector, model):
    ...
    # Detect faces
    detected_faces = face_detector.detectMultiScale(gray, scaleFactor=1.2, minNeighbors=10, minSize=(5, 5),
    ...
    if len(detected_faces) > 0:
        ...
        for (x, y, w, h) in detected_faces:
            ...
            cv2.putText(frame, label + " : " + str(confidence), (int(x), int(y)), cv2.FONT_HERSHEY_SIMPLEX, 1,
                        (255, 255, 255), 2)
